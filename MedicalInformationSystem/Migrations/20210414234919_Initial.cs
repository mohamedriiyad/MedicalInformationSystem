        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelativeOneName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RelativeOnePhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RelativeTwoName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RelativeTwoPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HospitalModelId = table.Column<int>(type: "int", nullable: true),
                    HospitalConfirmationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.HospitalConfirmationId,
